...
<div className="control">
  <button onClick={stop}>Turn Power {power ? 'OF' : 'ON'}</button>
...
const styleActiveKey = (key) => {
  key.parentElement.style.backgroundColor = "#A10035"
  key.parentElement.style.color = "#FFC4C4"
}

const deActivatedKey = (audio) => {
  audio.parentElement.style.backgroundColor = "#FFC4C4"
  audio.parentElement.style.color = "#A10035"
}
